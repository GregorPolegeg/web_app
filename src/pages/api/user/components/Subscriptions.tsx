...
const Subscriptions = () => { 
  ...
  return (
    <div className="flex h-full items-center justify-center bg-gradient-to-t from-sky-500 to-sky-100">
      <div className="flex bg-gray-100 p-10 text-black shadow-xl">
        <div className="flex flex-col gap-2">
          <div className="h-full bg-white p-6 text-black ">
            <div className="flex justify-center pb-10 text-xl text-black ">
              <button
                onClick={() => setSelectedSubscription(SubscriptionsProps.day)}
                className={`duration-700 border-r ${selectedSubscription === SubscriptionsProps.day?"bg-sky-600":"bg-sky-500"} px-10 py-2 font-medium text-white hover:bg-sky-600`}
              >
                DAY
              </button>
              <button
                onClick={() => setSelectedSubscription(SubscriptionsProps.week)}
                className={`duration-700 ${selectedSubscription === SubscriptionsProps.week?"bg-sky-600":"bg-sky-500"} px-10 py-2 font-medium text-white hover:bg-sky-600`}
              >
                WEEK
              </button>
              <button
                ...
                className={`duration-700 border-l ${selectedSubscription === SubscriptionsProps.month?"bg-sky-600":"bg-sky-500"} border-white px-10 py-2 font-medium text-white hover:bg-sky-600`}
              >
                MONTH
              </button>
            </div>
            <h2 className="border-b border-gray-300 pb-10 text-center text-6xl tracking-tighter">
            ...
            <div className="flex items-center gap-3 p-1 pb-3 pt-8">
          ...
          <button className="mt-1 bg-sky-500 py-3 text-2xl font-bold text-white duration-700 hover:bg-sky-600">
            SUBSCRIBE
          </button>
        </div>
      </div>
